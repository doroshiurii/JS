...
function calc() {
  ...
  function getStaticInfo(selector, activeClass) {
    var elemets = document.querySelectorAll(selector);
...
/* harmony import */ var _services_services_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../services/services.js */ "./js/services/services.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_services_services_js__WEBPACK_IMPORTED_MODULE_11__.postData)('http://localhost:3000/requests', json).then(function (data) {
...
function slider(_ref) {
  var container = _ref.container,
      ...
      prewArrow = _ref.prewArrow,
      totalCounter = _ref.totalCounter,
      currentCpunter = _ref.currentCpunter,
  ...
  var slides = document.querySelectorAll(slide),
      ...
      current = document.querySelector(currentCpunter),
  ...
  function replaceNotDigits(width) {
